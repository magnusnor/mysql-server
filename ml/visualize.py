...
def plot_exec_time_top_n_fastest_queries(workload, n, save=False):
    ...
    if dfs is not None:
        ...
        plt.legend(handles, labels, loc='upper center', bbox_to_anchor=(0.5, 1.3))
...
def main():
    ...
    plot_exec_time_top_n_slowest_queries("job-light", 10, save)
    plot_exec_time_top_n_fastest_queries_relative("job-light", 10, save)
